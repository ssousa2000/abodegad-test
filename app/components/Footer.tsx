      ...
      <div className="px-2 sm:px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            >
              <Image
                ...
                alt={`${business.name} — La Dalmacia, restaurante en Miraflores`}
                width={120}
                height={60}
          ...
          <div className="h-full w-full flex items-center">
            <iframe
              title={`Ubicación de ${business.name} en Google Maps — ${business.address.street}, ${business.address.neighborhood}`}
        ...
        <div className="mt-2 pt-2 border-t border-darkgreen/40 text-center text-xs text-darkgreen">
          <p>
            &copy; {new Date().getFullYear()} {business.name}. Todos los
            derechos reservados.
          </p>
        </div>
      </div>
